...
import static ankitsingh.smartpdfeditor.util.Constants.ADD_IMAGES;
import static ankitsingh.smartpdfeditor.util.Constants.ADD_IMAGES_KEY;
import static ankitsingh.smartpdfeditor.util.Constants.ADD_PASSWORD_KEY;
import static ankitsingh.smartpdfeditor.util.Constants.ADD_PWD;
import static ankitsingh.smartpdfeditor.util.Constants.ADD_TEXT_KEY;
import static ankitsingh.smartpdfeditor.util.Constants.ADD_WATERMARK;
import static ankitsingh.smartpdfeditor.util.Constants.ADD_WATERMARK_KEY;
import static ankitsingh.smartpdfeditor.util.Constants.BUNDLE_DATA;
import static ankitsingh.smartpdfeditor.util.Constants.COMPRESS_PDF;
import static ankitsingh.smartpdfeditor.util.Constants.COMPRESS_PDF_KEY;
import static ankitsingh.smartpdfeditor.util.Constants.EXCEL_TO_PDF_KEY;
import static ankitsingh.smartpdfeditor.util.Constants.EXTRACT_IMAGES;
import static ankitsingh.smartpdfeditor.util.Constants.EXTRACT_IMAGES_KEY;
import static ankitsingh.smartpdfeditor.util.Constants.EXTRACT_TEXT_KEY;
import static ankitsingh.smartpdfeditor.util.Constants.HISTORY_KEY;
import static ankitsingh.smartpdfeditor.util.Constants.IMAGE_TO_PDF_KEY;
import static ankitsingh.smartpdfeditor.util.Constants.INVERT_PDF_KEY;
import static ankitsingh.smartpdfeditor.util.Constants.MERGE_PDF_KEY;
import static ankitsingh.smartpdfeditor.util.Constants.PDF_TO_IMAGES;
import static ankitsingh.smartpdfeditor.util.Constants.PDF_TO_IMAGES_KEY;
import static ankitsingh.smartpdfeditor.util.Constants.QR_BARCODE_KEY;
import static ankitsingh.smartpdfeditor.util.Constants.REMOVE_DUPLICATE_PAGES_KEY;
import static ankitsingh.smartpdfeditor.util.Constants.REMOVE_PAGES;
import static ankitsingh.smartpdfeditor.util.Constants.REMOVE_PAGES_KEY;
import static ankitsingh.smartpdfeditor.util.Constants.REMOVE_PASSWORD_KEY;
import static ankitsingh.smartpdfeditor.util.Constants.REMOVE_PWd;
import static ankitsingh.smartpdfeditor.util.Constants.REORDER_PAGES;
import static ankitsingh.smartpdfeditor.util.Constants.REORDER_PAGES_KEY;
import static ankitsingh.smartpdfeditor.util.Constants.ROTATE_PAGES;
import static ankitsingh.smartpdfeditor.util.Constants.ROTATE_PAGES_KEY;
import static ankitsingh.smartpdfeditor.util.Constants.SPLIT_PDF_KEY;
import static ankitsingh.smartpdfeditor.util.Constants.TEXT_TO_PDF_KEY;
import static ankitsingh.smartpdfeditor.util.Constants.VIEW_FILES_KEY;
import static ankitsingh.smartpdfeditor.util.Constants.ZIP_TO_PDF_KEY;
...
import ankitsingh.smartpdfeditor.activity.FavouritesActivity;
import ankitsingh.smartpdfeditor.activity.MainActivity;
import ankitsingh.smartpdfeditor.customviews.MyCardView;
import ankitsingh.smartpdfeditor.fragment.texttopdf.TextToPdfFragment;
